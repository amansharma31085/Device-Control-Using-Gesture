...
* **OpenCV: For webcam integration, image processing, and real-time video manipulation.**

* **MediaPipe: A powerful framework for real-time hand detection and landmark extraction.**

* **PyTorch: The deep learning framework used to build and train the GestureNet neural network.**

* **PyAutoGUI: For programmatic control of the mouse, keyboard, and screen interactions.**

* **Scikit-learn: Utilized for data splitting (e.g., train_test_split) during model training.**
...
3 **Collect Data for Your Gestures:**
...
4 **Train Your Gesture Recognition Model:**
...
6 **Real-time Gesture Prediction (Optional):**
...
7 **Retrain Model (Advanced/Optional):**
